...
short int funcion3(short int n1, short int n2);
...
{       
    ...
    var = 5;
    funcion1();
    dato1 = funcion2(); // Incrementar 3 a var
    dato2 = funcion3(5, 12); // Suma de dos numeros
    dato3 = funcion4(cadena); // Longitud de la cadena
